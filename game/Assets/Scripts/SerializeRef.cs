...
public class SerializeRef : MonoBehaviour
{
    [SerializeField]
    public QYObject[] obj;
    [SerializeField]
    public QYObjectS[] objs;
    ...
    {
        L.BeginClass(typeof(SerializeRef), typeof(MonoBehaviour));
    ...
    private static int get_ref(System.IntPtr L)
    {
        try
        {
            SerializeRef rf = ToLua.ToObject(L, 1) as SerializeRef;
