...
public class UIDragObject : MonoBehaviour
{
    ...
    bool isDrag = false;
    /// <summary>
    /// 拖动状态事件，0=开始拖动，1=正在拖动，2=结束拖动，3=未拖动结束
    /// </summary>
    public System.Action<UIDragObject, int> onDragStatus;
    //public Callback<UIDragObject, bool> OnDragPress;
	...
	void OnPress (bool pressed)
	{
		if (enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			else if (mPressed && mTouchID == UICamera.currentTouchID)
			{
                ...
                {
                    isDrag = false;
                    if (onDragStatus != null) onDragStatus(this, 2);
                }
                else if (onDragStatus != null) onDragStatus(this, 3);
	...
	void OnDrag (Vector2 delta)
	{
		if (mPressed && mTouchID == UICamera.currentTouchID && enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			if (mPlane.Raycast(ray, out dist))
			{
                ...
                {
                    isDrag = true;
                    if (onDragStatus != null) onDragStatus(this, 0);
                }
                ...
                if (onDragStatus != null) onDragStatus(this, 1);
			}
		}
	}
