...
public class UITexture : UIBasicSprite
{
    ...
    //add by kiol 2018.3.15
    [System.NonSerialized] public Rect parentRect = new Rect(0f, 0f, 1f, 1f);
	...
	public override void OnFill (List<Vector3> verts, List<Vector2> uvs, List<Color> cols)
	{
        ...
        Rect outer = new Rect(parentRect.x + mRect.x * parentRect.width, parentRect.y + mRect.y * parentRect.height, parentRect.width * mRect.width, parentRect.height * mRect.height);
        outer.Set(outer.x * tex.width, outer.y * tex.height, tex.width * outer.width, tex.height * outer.height);
        ///////////
        Rect inner = outer;
		Vector4 br = border;
		inner.xMin += br.x;
